...
| style | bool | Whether to use black to autoformat code in returned string representation. | None |
| comment | str | Line prefix to use when rendering the evaluated results. | None |
| terminal | bool | Whether to apply syntax highlighting to the string representation.
Requires optional dependency Pygments. | None |
| tree | libcst.Module | Parsed LibCST concrete syntax tree of input code. | None |
| statements | List[Statement] | List of individual statements parsed from input code. | None |
| results | List[Result] | List of evaluated results corresponding to each item of statements. | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| result | Any | Some Python object, intended to be the return value of evaluated Python code. | None |
| comment | str | Line prefix to use when rendering the result for a reprex. | None |
...
| stmt | Union[libcst.SimpleStatementLine, libcst.BaseCompoundStatement] | LibCST parsed
statement. | None |
| style | bool | Whether to autoformat the source code with black. | None |
